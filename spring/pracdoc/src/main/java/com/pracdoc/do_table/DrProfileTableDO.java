...
public class DrProfileTableDO {
	...
	@Column(name = "dr_specialization_id")
	...
	@Column(name = "dr_profile_pic_url")
	private String dr_profile_pic_url;

	@Column(name = "dr_clinic_pics_url")
	private String dr_clinic_pics_url;

	@Column(name = "dr_clinic_lat")
	private String dr_clinic_lat;

	@Column(name = "dr_clinic_long")
	private String dr_clinic_long;

	@Column(name = "dr_morning_time_slot_id")
	private int dr_morning_time_slot_id;

	@Column(name = "dr_afternoon_time_slot_id")
	private int dr_afternoon_time_slot_id;

	@Column(name = "dr_evening_time_slot_id")
	private int dr_evening_time_slot_id;

	@Column(name = "dr_night_time_slot_id")
	private int dr_night_time_slot_id;

	@Column(name = "dr_working_day")
